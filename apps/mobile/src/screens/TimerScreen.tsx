      ...
      <View style={styles.favoriteWrap}>
        {favoriteLocations.length ? (
          ...
          <Text style={styles.favoriteEmpty}>
            No saved favorites yet. Add one from Menu {" > "} Settings {" > "} Location Settings.
          </Text>
        )}
      </View>
...
function createStyles(colors: ReturnType<typeof useAppTheme>["colors"]) {
  return StyleSheet.create({
    ...
    timerHeroText: { color: colors.textPrimary, fontSize: 16, fontWeight: "800", lineHeight: 22 },
    ...
    contactLabel: { color: colors.textSecondary, fontSize: 13, fontWeight: "600" },
    contactTime: { color: colors.textMuted, fontSize: 12, marginTop: 2 },
    contactTimeLocal: { color: "#8fc8ff", fontSize: 12, marginTop: 2 },
    contactAlarm: { alignItems: "center", justifyContent: "center" },
    alarmLabel: { color: colors.textMuted, fontSize: 11, marginBottom: 2 },
